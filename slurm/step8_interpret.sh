#!/bin/bash
#SBATCH --job-name=clignet_interpret
...
#-----------------------------
# Step 8: Integrated Gradients interpretability + failure analysis (F1-F4)
# Requires trained B8 checkpoint from Step 5
#-----------------------------
python -u scripts/interpret.py
